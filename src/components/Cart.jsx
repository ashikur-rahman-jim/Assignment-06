    ...
    return (
        <section className="bg-gray-50 py-12">
            <div className="container mx-auto px-4 max-w-2xl bg-white rounded-xl shadow-md p-6">
                ...
                {/* Checkout Button */}
                <div className="mt-6">
                    <button className="w-full py-3 px-4 bg-linear-to-t from-[#4F39F6] to-[#9514FA] text-white font-semibold rounded-full cursor-pointer hover:opacity-90 transition">
                        Proceed To Checkout
                    </button>
                </div>
